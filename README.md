![](RackMultipart20210406-4-bwzpm8_html_72041aa56a969de7.png)

| Opleiding: | Bachelor in de
 elektronica-ICT | Academiejaar: | 2018 - 2019 |
| --- | --- | --- | --- |
...
| _In te vullen door de docent_ |
| --- |
| Datum ontvangst:

 |
 | Datum evaluatie en paraaf docent: |
 |
| Evaluatie |
| Structuur &amp; lay-out | - - | - | = | + | ++ |
| Inhoud | - - | - | = | + | ++ |
...
[1.Inleiding 3](#_Toc68619152)

[2.Materiaal lijst 3](#_Toc68619153)

[3.Uitgewerkt voorbeeld. 5](#_Toc68619154)

[3.1.Maken van een project 5](#_Toc68619155)

[3.2.Dobbelsteen 8](#_Toc68619156)

[3.3.Stappenteller 9](#_Toc68619157)

[3.4.Piano 10](#_Toc68619158)

[3.5.Melodie 11](#_Toc68619159)

[3.6.Blad, steen, schaar 12](#_Toc68619160)

[3.6.1.Spelen tegen andere mensen fysiek 12](#_Toc68619161)

[3.6.2.Blad, steen schaar tegen computer. 14](#_Toc68619162)

[4.Documentatie 18](#_Toc68619163)

[5.Figuren lijst: 18](#_Toc68619164)
...
![](RackMultipart20210406-4-bwzpm8_html_847520aada8ce8e1.gif)

_Figuur 1: micro:bit_

- USB kabel (micro USB B)

![](RackMultipart20210406-4-bwzpm8_html_b2ffe611bdb23fa.png)

_Figuur 2: micro USB B kabel_

- Eventueel 2 AAA batterijen en batterijhouder die geconnecteerd kan worden aan de micro:bit

![](RackMultipart20210406-4-bwzpm8_html_d837d12c20dcb4b7.png)

_Figuur 3: AAA batterijen en batterijhouder_
...
Als je wil starten met het project ga naar deze link: [https://makecode.microbit.org/](https://makecode.microbit.org/) dan kom je op dit scherm terecht:

![](RackMultipart20210406-4-bwzpm8_html_a636f837f4e76e54.png)

_Figuur 4: online code editor_

Om een nieuw project te maken klik op nieuw project:

![](RackMultipart20210406-4-bwzpm8_html_aaea3be164c7a61d.png)

_Figuur 5: code editor nieuw project maken_
...
![](RackMultipart20210406-4-bwzpm8_html_e303f35da61fae05.png)

_Figuur 6: nieuw project aanmaken naam_
...
![](RackMultipart20210406-4-bwzpm8_html_80f31dbb6de206ee.png)

_Figuur 7: startscherm online editor_
...
![](RackMultipart20210406-4-bwzpm8_html_25ba6fed6de0857f.png)

_Figuur 8: USB apparaat koppelen_
...
![](RackMultipart20210406-4-bwzpm8_html_7c6e653c5da40074.png)

_Figuur 9: code dobbelsteen_
...
![](RackMultipart20210406-4-bwzpm8_html_2b6d9e2102adff9c.png)

_Figuur 10: code stappenteller_
...
![](RackMultipart20210406-4-bwzpm8_html_f7f39cfebb660983.png)

_Figuur 11: code piano_

  1.
## Melodie

_Figuur 12: melodie editor_

D ![](RackMultipart20210406-4-bwzpm8_html_bebb17225468d702.png) e piano is leuk omdat je aan de hand van eigen ingeving van het moment een muziekje kan spelen, op het tempo dat je zelf wilt, met de noten die je voor handen hebt maar je kan zelf eindeloos combineren. In dit deel programmatje zal je op voorhand een muziekstukje kunnen maken en deze laten afspelen als je knop A en B tegelijkertijd indrukt.
...
![](RackMultipart20210406-4-bwzpm8_html_ae4e04cf1a829c11.png)

_Figuur 13: code melodie_
...
Kort samengevat als je in je handen klapt zal een willekeurig getal beslissen of je blad, steen of schaar hebt. Deze info toont hij op het schermpje, als je dit samen wil spelen met iemand anders kan dit eenvoudig omdat je klapt starten bij beide mensen op zelfde moment het spelletje.
 ...
 ![](RackMultipart20210406-4-bwzpm8_html_8c5a9e49c24fe5b7.png)
 ![](RackMultipart20210406-4-bwzpm8_html_b7737cc93fb75853.png)

_Figuur 14: code blad, steen, schaar manueel_
...
_Figuur 15: waarheidstabel blad, steen, schaar_
...
![](RackMultipart20210406-4-bwzpm8_html_4ae92c6c50645e80.png) ![](RackMultipart20210406-4-bwzpm8_html_726150ffe2f67367.png)
 ![](RackMultipart20210406-4-bwzpm8_html_8437dca8034f68af.png)
 ![](RackMultipart20210406-4-bwzpm8_html_daf838c6b73d7db7.png)

_Figuur 16: code blad, steen, schaar computer_

1.
# Documentatie

Meer info of code kan je vinden op mijn GitHub profiel ([https://github.com/robindeleu/techniekacademie](https://github.com/robindeleu/techniekacademie)), hier kan je de javascript code vinden of python code als iemand niet met de blokken code zou werken. Ook zal je daar de .hex file vinden. Als je deze download en dan kopieert op de micro:bit via de windows verkenner zal hij het programma laden op het bordje en zal je mijn demo kunnen gebruiken.

1.
# Figuren lijst:

[Figuur 1: micro:bit 3](#_Toc68619087)

[Figuur 2: micro USB B kabel 4](#_Toc68619088)

[Figuur 3: AAA batterijen en batterijhouder 4](#_Toc68619089)

[Figuur 4: online code editor 5](#_Toc68619090)

[Figuur 5: code editor nieuw project maken 5](#_Toc68619091)

[Figuur 6: nieuw project aanmaken naam 6](#_Toc68619092)

[Figuur 7: startscherm online editor 6](#_Toc68619093)

[Figuur 8: USB apparaat koppelen 7](#_Toc68619094)

[Figuur 9: code dobbelsteen 8](#_Toc68619095)

[Figuur 10: code stappenteller 9](#_Toc68619096)

[Figuur 11: code piano 10](#_Toc68619097)

[Figuur 12: melodie editor 11](/D:%5CUsers%5Cdeleu%5CDocuments%5CVIVES%5CTechniekacademie%5Copdracht-G.docx#_Toc68619098)

[Figuur 13: code melodie 11](#_Toc68619099)

[Figuur 14: code blad, steen, schaar manueel 13](#_Toc68619100)

[Figuur 15: waarheidstabel blad, steen, schaar 15](#_Toc68619101)

[Figuur 16: code blad, steen, schaar computer 17](#_Toc68619102)

#


**KATHOLIEKE HOGESCHOOL VIVES** – **STUDIEGEBIED IW&amp;T** – **CAMPUS BRUGGE** 16
